      ...
      <textarea name="opis" rows="8" cols="40"></textarea>
          ...
          <?php
            ...
            if($r['id_kat']==20){
              ...
              echo "<input type='checkbox' name='kateg[]' value='{$r['id_kat']}'>".$r['kategorija']."<br/>";
              echo "</div>";
            }else {
                echo "<div class='col-md-6'>";
                echo "<input type='checkbox' name='kateg[]' value='{$r['id_kat']}'>".$r['kategorija']."<br/>";
...
$kategorije=$_POST['kateg'];
foreach($_POST['kateg'] as $item){
  $upitkat="INSERT INTO user_cat VALUES('',$item")"
}
...
$rezupitprikazus=$con->query($upitprikaz);
$r3=mysqli_fetch_array($rezupitprikazus);
$iduser1=$r3['id_user'];
$kategorije=$_POST['kateg'];
foreach($_POST['kateg'] as $item){
  $upitkat="INSERT INTO user_cat VALUES('',$item,".$iduser1.")"
}
